...
const TrendingVideosPage = () => {
    ...
    const observer = new IntersectionObserver(
      (entries) => {
        ...
        if (
          ...
          initialLoadDone.current && // 👈 don't fire until page 0 is done
          nextPage !== null &&
          nextPage > 0 // 👈 never fetch page 0 from observer
        ) {
  ...
  return (
    <div className="text-white min-h-screen mx-10 text-sm my-5 pb-10">
      <div className="flex flex-col gap-2 mb-10">
        <h1 className="text-xl font-black">Bảng Xếp Hạng Xu Hướng</h1>
        <p className="text-slate-300">
          Cập nhật liên tục những nội dung giải trí bùng nổ mà bạn không thể bỏ
          lỡ trong ngày.
        </p>
      </div>
