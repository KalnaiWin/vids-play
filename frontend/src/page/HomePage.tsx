      ...
      <div className="w-full h-140 relative rounded-xl">
        ...
        <div className="absolute top-0 left-0 p-4">
          <div className="flex gap-3 items-center">
            <div className="uppercase text-slate-200 bg-blue-600 rounded-xl px-2 py-1 flex items-center font-semibold md:text-sm text-xs">
              ● Feature live
            </div>
            <p className="uppercase font-medium md:text-sm text-xs text-blue-300">
              Made by Phuc
            </p>
          </div>
          ...
          <div className="flex md:flex-row flex-col gap-3 items-center w-full">
            ...
            <button className="text-white bg-slate-500/70 px-5 py-2 rounded-full text-xl font-medium border border-slate-500 cursor-pointer transition-all hover:bg-slate-600/70 md:w-fit w-full">
              ✚ Follow Channel
            </button>
          </div>
        </div>
